...
layui.use(['bodyTab', 'form', 'element', 'layer', 'jquery', 'table'], function () {
  ...
  $(".hideMenu").click(function () {
    ...
    if (fold) {
      $(".hideImg").attr("src", "http://myshares.oss-cn-hangzhou.aliyuncs.com/unfold.png");
      fold = false
    } else {
      $(".hideImg").attr("src", "http://myshares.oss-cn-hangzhou.aliyuncs.com/fold.png");
      fold = true
    }
    //渲染顶部窗口
    tab.tabMove();
  ...
  // 添加新窗口, 这事件基本都是顶部右侧的, 都注掉了, 目前只剩登出..
