...
<div class="row">
    ...
    <script type="text/javascript" src="${staticUrl}/static/layui-v2.5.6/lay/modules/jquery.js"></script>
    <script type="text/javascript" src="${staticUrl}/static/js/echarts.min.js"></script>
