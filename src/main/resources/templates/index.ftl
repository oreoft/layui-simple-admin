...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-header header">
        <div class="layui-main">
            <a href="#" class="logo">
                <#--                <img src="${staticUrl}/static/images/dashixionglogo.png">  -->
                <span>演示后台</span>
            </a>
            <!-- 显示/隐藏菜单 -->
            <#--  <a href="javascript:" class="iconfont hideMenu icon-menu1"></a>  -->
            <a href="javascript:" class="hideMenu"><img class="hideImg" src="http://myshares.oss-cn-hangzhou.aliyuncs.com/fold.png"></a>
            <#--<!-- 搜索 &ndash;&gt;-->
            ...
            <ul class="layui-nav top_menu">
                ...
                <li class="layui-nav-item" mobile>
                    <a href="javascript:" class="mobileAddTab" data-url="${base}/admin/system/user/changePassword"><i class="iconfont icon-shezhi1" data-icon="icon-shezhi1"></i><cite>设置</cite></a>
                </li>
                <li class="layui-nav-item" mobile>
                ...
                <li class="layui-nav-item" pc>
                    <a href="javascript:">
                        <#--<img src="<#if (currentUser.icon??)>${currentUser.icon}<#else>${staticUrl}/static/images/face.jpg</#if>" class="layui-circle" width="35" height="35">-->
...
<#--                        <dd><a href="javascript:" class="changeSkin"><i class="iconfont icon-huanfu"></i><cite>更换皮肤</cite></a></dd>-->
    ...
    <div class="layui-side layui-bg-black">
        <#--  <div class="user-photo">
            <a class="img"><img src="${staticUrl}/static/images/dashixionglogo.png"></a>
    ...
    <div class="layui-body layui-form">
        <div class="layui-tab marg0" lay-filter="bodyTab" id="top_tabs_box" style="border-bottom:0px;">
            <ul class="layui-tab-title top_tab" id="top_tabs" style="display:none;">
                <li class="layui-this" lay-id="1"><i class="iconfont icon-computer"></i> <cite>后台首页</cite></li>
            </ul>
            <!--
...
<script type="text/javascript" src="${staticUrl}/static/js/leftNav.js?v=2.0"></script>
<script type="text/javascript" src="${staticUrl}/static/js/index.js?t=3.0"></script>
</body>
</html>