...
<head>
    ...
    <link rel="stylesheet" href="${staticUrl}/static/colorpicker/colpick.css" media="all" />
    <style type="text/css">
...
<#--    </div>-->
    ...
    <div class="layui-form-item">
        <div class="layui-input-block">
            ...
            <button class="layui-btn layui-btn-primary" onclick="cancel();">我不改了</button>
        </div>
    </div>
</form>
...
<script src="${staticUrl}/static/js/jquery.min.js"></script>
<script type="text/javascript" src="${staticUrl}/static/layui-v2.5.6/layui.js"></script>
<script type="text/javascript" src="${staticUrl}/static/colorpicker/colpick.js"></script>
<script>
    var iconShow,$;
