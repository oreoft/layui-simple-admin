...
<#--    <link rel="stylesheet" href="https://static.mysiteforme.com/layui-treetable/layui-v2.5.6/css/layui.css">-->
...
<#--<script src="https://static.mysiteforme.com/layui-treetable/layui-v2.5.6/layui.js"></script>-->
...
<script type="text/javascript">
    layui.use(['tree', 'layer','table'], function() {
        ...
        var layout = [
            ...
            },
            {
                ...
                style: 'width: 10%',
                render:function(row){
                    return undefined === row.ctime?"" : new Date(row.ctime).Format("yyyy-MM-dd hh:mm:ss");
                }
            },
            {
                name: '操作',
    ...
    var delMenu =function(data){
        layer.confirm("你确定要删除该菜单么？这将会使得其下的所有子菜单都删除",{btn:['恩,我确定','我再想想']},
                function(){
