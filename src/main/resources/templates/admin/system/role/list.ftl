...
<script>
    layui.use(['layer','form','table'], function() {
        ...
        table.on('tool(demo)', function(obj){
            ...
            if(obj.event === "del"){
                layer.confirm("你确定要删除该角色么？",{btn:['恩,我确定','我再想想']},
                        function(){
        ...
        t = {
            ...
            cols: [[
                ...
                {field:'ctime',  title: '创建时间',    width:'14%',templet:'<div>{{ layui.laytpl.toDateString(d.ctime) }}</div>',unresize: true}, //单元格内容水平居中
                {field:'mtime',  title: '修改时间',    width:'14%',templet:'<div>{{ layui.laytpl.toDateString(d.mtime) }}</div>',unresize: true}, //单元格内容水平居中
        ...
        var active={
            ...
            deleteSome : function(){
                ...
                if(data.length > 0){
                    ...
                    layer.confirm("你确定要删除这些角色么？",{btn:['恩,我确定','我再想想']},
                            function(){
