...
<head>
    ...
    <link rel="stylesheet" href="../../layuiadmin/layui-v2.5.6/css/layui.css" media="all">
...
<script src="../../layuiadmin/layui-v2.5.6/layui.js"></script>
<script>
    layui.config({
        ...
        form.on('submit(LAY-user-reg-submit)', function(obj){
            ...
            admin.req({
                ...
                ,data: field
                ,done: function(res){
                    layer.msg('您的注册信息已提交成功，我们将在24小时内完成审核', {
                        offset: '15px'
                        ,icon: 1
                        ,time: 3000
                    }, function(){
