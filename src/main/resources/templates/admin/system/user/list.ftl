    ...
    layui.use(['layer','form','table'], function() {
        ...
        t = {
            ...
            cols: [[
                ...
                {field: 'phone', title: '电话(也可以登陆)', width: '12%'},
                {field: 'locked', title: '账号状态', width: '12%', templet: '#userStatus'},
                {
                    field: 'ctime',
                    title: '创建时间',
                    width: '18%',
                    templet: '<div>{{ layui.laytpl.toDateString(d.ctime) }}</div>',
                    unresize: true
                }, //单元格内容水平居中
        ...
        table.on('tool(demo)', function (obj) {
            ...
            if(obj.event === "del"){
                layer.confirm("你确定要删除该用户么？",{btn:['我确定','我再想想']},
                    function(){
        ...
        var active={
            ...
            deleteSome : function(){                        //批量删除
                ...
                if(data.length > 0){
                    ...
                    layer.confirm("你确定要删除这些用户么？",{btn:['恩,我确定','我再想想']},
                        function(){
