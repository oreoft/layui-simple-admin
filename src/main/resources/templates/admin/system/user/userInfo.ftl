...
<head>
    ...
    <link rel="stylesheet" href="${staticUrl}/static/css/user.css?v=2.0" media="all" />
</head>
...
<form class="layui-form">
    <div class="user_left">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="tel" value="${userinfo.phone}" name="phone" placeholder="请输入手机号码" lay-verify="phone" class="layui-input userPhone">
            </div>
        </div>
        <div class="layui-form-item">
