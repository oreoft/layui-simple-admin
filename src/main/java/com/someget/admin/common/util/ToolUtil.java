...
public class ToolUtil {
    ...
    public static void entryptPassword(User user) {
        ...
        byte[] hashPassword = Digests.sha1(user.getPassword().getBytes(), salt, SecurityConstants.HASH_INTERATIONS);
    ...
    public static String entryptPassword(String paramStr, String salt) {
        if (StringUtils.isNotEmpty(paramStr)) {
            ...
            byte[] hashPassword = Digests.sha1(paramStr.getBytes(), saltStr, SecurityConstants.HASH_INTERATIONS);
    ...
    public static Map<String, String> getAddressByIP(String ip) {
        ...
        try {
            ...
            sb.append(ip);
            String result = HttpUtil.get(sb.toString(), Charset.defaultCharset());
