...
import com.someget.admin.common.base.CaptchaFormAuthenticationFilter;
...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean(@Qualifier("authRealm") AuthRealm authRealm) {
        ...
        filterChainDefinitionMap.put("/admin/system/user/**", "anon");
    ...
    public RedisManager redisManager() {
        ...
        manager.setHost(String.format("%s:%d", jedisHost, jedisPort));
        manager.setDatabase(jedisDatabase);
    ...
    public RedisSessionDAO redisSessionDAO() {
        ...
        sessionDAO.setKeyPrefix("admin_");
